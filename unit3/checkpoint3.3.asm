...
// detect_VICII(byte* zeropage($d) address)
detect_VICII: {
    .label p = 9
    .label v1 = $11
    .label i = 5
...
// memset(void* zeropage($d) str, byte register(X) c, word zeropage(5) num)
memset: {
    .label end = 5
    .label dst = $d
    .label num = 5
